...
sub_num_vec<-c(4:9,11:13, 15:16,18:27,29,32:35) 

 # if under the subject's folder there are a number of different subfolders for differnt experiments then add a string with the name (e.g. "SoA_Training").
